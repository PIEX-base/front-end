...
export const QuemSomos = () => {
  return (
    <div className="flex flex-col  min-h-screen text-black px-24 pt-12 ">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-8 mb-8">
        <div className="ml-30 flex justify-center md:justify-start">
          <img
            src={Imagem2}
            alt="imagem2"
            className="rounded-full border-4 border-yellow-500 object-cover w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 mr-30"
          />
        </div>
        <div className="md:w-1/2">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center gap-8 mb-8">
        <div className="ml-30 flex justify-center md:justify-start">
          <img
            src={Imagem4}
            alt="imagem4"
            className="rounded-full object-cover border-4 border-yellow-500 w-32 h-32 md:w-40 md:h-40 lg:w-48 lg:h-48 mr-30"
          />
        </div>
        <div className="md:w-1/2">
